...
public class RaasClientException 
        extends APIException
        implements java.io.Serializable {
    private static final long serialVersionUID = 5066646150019604351L;
    private Date timestamp;
    private String requestId;
    private String path;
    private int httpCode;
    private String httpPhrase;
    private List<RaasClientErrorModel> errors;
    /** GETTER
     * Request timestamp
     */
     ...
     */
    @JsonGetter("errors")
    public List<RaasClientErrorModel> getErrors ( ) { 
        return this.errors;
    }
     ...
     */
    @JsonSetter("errors")
    private void setErrors (List<RaasClientErrorModel> value) { 
        this.errors = value;
    }
